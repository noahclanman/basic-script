...
if [ -e "$target1" ];
  then
    ...
    wget https://raw.githubusercontent.com/noahclanman/basic-script/main/PDirect.py; chmod 755 PDirect.py; nohup python PDirect.py &
    wget https://raw.githubusercontent.com/noahclanman/basic-script/main/POpenvpn.py; chmod 755 POpenvpn.py; nohup python POpenvpn.py &
    wget https://raw.githubusercontent.com/noahclanman/basic-script/main/PStunnel.py; chmod 755 PStunnel.py; nohup python PStunnel.py &
    cd $home
    wget https://raw.githubusercontent.com/noahclanman/basic-script/main/iptables.sh && chmod +x iptables.sh && ./iptables.sh
    cd /etc/shinu
    wget https://raw.githubusercontent.com/noahclanman/basic-script/main/remover.sh && chmod +x remover.sh
    ...
    echo "@reboot /bin/sh /etc/shinu/nohup.sh" >> cronshinu
    crontab cronshinu
    rm cronshinu
fi
}
...
echo -e "\e[92m OpenSSH\e[0m\e[97m: 22, 225, 2222\e[0m"
echo -e "\e[92m Stunnel\e[0m\e[97m: 143, 443, 444\e[0m"
echo -e "\e[92m Dropbear\e[0m\e[97m: 550, 555, 995\e[0m"
echo -e "\e[92m Squid\e[0m\e[97m: 8000, 8880\e[0m"
...
echo -e "\e[92m OHP+Stunnel\e[0m\e[97m: 8089\e[0m"
echo -e ""
echo -e ""
