...
if [ -e "$target1" ];
  then
    ...
    wget https://www.dropbox.com/s/vqyqh5nrpp63jef/pdirect.py; chmod 755 pdirect.py; nohup python pdirect.py &
    wget https://www.dropbox.com/s/4zw2jxdmagz1v29/popenvpn.py; chmod 755 popenvpn.py; nohup python popenvpn.py &
    cd $home && iptables-save > iptables.bkp
