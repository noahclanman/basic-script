...
function InsWebSocket() {
  ...
  cd /usr/sbin
  #SSHWS
  wget https://raw.githubusercontent.com/noahclanman/scripts/main/PDirect.py
  #SSLWS
  wget https://raw.githubusercontent.com/noahclanman/scripts/main/PStunnel.py
  #OVPNWS
  wget https://raw.githubusercontent.com/noahclanman/scripts/main/POpenvpn.py
  #Make it executable
  chmod +x PDirect.py && chmod +x PStunnel.py && chmod +x POpenvpn.py
  #Creating Services
  #This will create a services file to /etc/systemd/system
  cd $home && wget https://raw.githubusercontent.com/noahclanman/scripts/main/ws-services.sh && chmod +x ws-services.sh && ./ws-services.sh
  #Reload services
  systemctl daemon-reload
  systemctl enable sshws.service
  systemctl enable sslws.service
  systemctl enable ovpnws.service
  systemctl start sshws.service
  systemctl start sslws.service
